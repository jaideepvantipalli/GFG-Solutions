<h2><a href="https://www.geeksforgeeks.org/problems/minimum-difference-pair5444/1?page=1&category=two-pointer-algorithm&sortBy=difficulty">Minimum difference pair</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array<strong> arr[]</strong>. find the minimum difference between any pair in the given array.</span></p>
